...
namespace application
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                Environment.SetEnvironmentVariable("DB_CONNECTION", "Persist Security info=True;Server=localhost;Port=3306;Database=dbAPI_Integration;Uid=root;Pwd=gostack");
            ...
            }).AddJwtBearer(bearerOptions =>
            {
                ...
                paramsValidattion.ValidAudience = Environment.GetEnvironmentVariable("Audience");
                paramsValidattion.ValidIssuer = Environment.GetEnvironmentVariable("Issuer");
